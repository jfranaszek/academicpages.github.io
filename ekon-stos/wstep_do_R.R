...
dziennik<-data.frame(nr=1:5, nazwisko=c('Anski', 'Becki', 'Czeski', 'Demski', 'Ewski'), 
...
osoba<-list(imie="Adam",nazwisko="Absencki", wiek=43)
osoba$imie
mode(osoba$wiek)
...
# Jak poprawiæ funkcjê srednia? 

########################################################################################

# Ma³e zadanko na zachêtê: 
# Stwórz hipotetyczn¹ listê koñcowych ocen z RD2.
# Za³ó¿, ¿e grupa ma 20 studentów, identyfikowanych przez 5-cyfrowy numer indeksu.
# Numery indeksu s¹ losowo wybrane ze zbioru 40000-45000 i posortowane rosn¹co.
...
# Sk¹d wzi¹æ dane?
# Do zabawy:
# data() w R wyœwietli listê dostêpnych datasetów
data()
